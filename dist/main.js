    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                smallAnimation_1 = setInterval(function () {
                    if (submitButton) {
                        submitButton.textContent += ".";
                    }
                    if (dataFromFetch_1) {
                        clearInterval(smallAnimation_1);
                        submitButton ? (submitButton.textContent = "Fetch ") : "";
                        pasteOutput(dataFromFetch_1);
                    }
                }, 350);
                _a.label = 2;
...
function triggerFetch(url) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://resumee-api-production.up.railway.app".concat(url))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
